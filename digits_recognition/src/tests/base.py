...
np.save(DATA_DIR / "losses.npy", losses_epochs)
np.save(DATA_DIR / "accs.npy", accs_epochs)
np.save(DATA_DIR / "train_accuracy.npy", train_accs_epochs)

# 95.22, 96.66, 97.08 ... -> 98.05 (30 but with final epochs distinguished by 0.01%)